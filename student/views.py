    ...
    for subject in subjects:
        ...
        if subject.subject_type == 2:
            if grade:
                ...
                final_average.append(float(grade.final) / 4)
            ...
            if subject.title != 'Araling Panlipunan':
                if grade:
                    ...
                    mfinal_average.append(float(grade.final) * 0.4)
            else:
                if grade:
                    ...
                    mfinal_average.append(float(grade.final))
        else:
            if grade:
                ...
                final_average.append(float(grade.final))
